export default function AboutSection({ certificateHref = "#certificates" }: { certificateHref?: string }) {
  return (
    <section className="about section" id="about">
      ...
      <div className="about-copy"><p className="eyebrow">About Thoughts</p><h2>Editing with intent,<br />not just effects.</h2><p>I’m Salman, a video editor with 3+ Years of Professional Experience. I help creators, consultants and businesses turn ideas and raw footage into polished videos that feel clear, current and memorable.</p>
        <div className="stats"><div><strong>3+</strong><span>Years of Professional Experience</span></div><div><strong>3</strong><span>Editors in the team</span></div><div><strong>1M+</strong><span>Social media views</span></div></div>
